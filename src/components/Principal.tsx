    ...
    return (
        <div id="home" className="w-full h-screen flex items-center justify-center">
            ...
            <div className="relative z-20 w-full h-[70%] flex flex-col items-center justify-end">
                ...
                <p className="mb-5 text-center"> - Atendimento <span className="text-[#de990e]"> EXCLUSIVO </span>
                    - Roteiro<span className="text-[#de990e]"> VOCÊ QUE MANDA </span> <br />
                    - Experiência<span className="text-[#de990e]"> DIFERENCIADA </span>
                    - Fotos e vídeos<span className="text-[#de990e]"> CORTESIA </span>
                </p>
                <motion.button
